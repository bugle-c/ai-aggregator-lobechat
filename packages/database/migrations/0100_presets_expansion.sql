...
VALUES
  ...
  ('dolly-zoom-in', 'video', 'bytedance/seedance-2.0-fast/text-to-video', 'camera',
   ...
   'https://rustfs.gptweb.ru/presets/dolly-zoom-in.mp4',
   ARRAY['top_choice'], 50),
  ...
  ('360-orbit', 'video', 'kwaivgi/kling-v3.0-pro/text-to-video', 'camera',
   ...
   'https://rustfs.gptweb.ru/presets/360-orbit.mp4',
   ARRAY['trending'], 60),
  ...
  ('fpv-drone', 'video', 'bytedance/seedance-2.0-fast/text-to-video', 'camera',
   ...
   '{"aspect_ratio":"16:9","duration_sec":5}',
   'https://rustfs.gptweb.ru/presets/fpv-drone.mp4',
  ...
  ('crane-up', 'video', 'bytedance/seedance-2.0-fast/text-to-video', 'camera',
   ...
   '{"aspect_ratio":"16:9","duration_sec":6}',
   'https://rustfs.gptweb.ru/presets/crane-up.mp4',
   ARRAY[]::text[], 80),
  ...
  ('water-splash', 'video', 'kwaivgi/kling-v3.0-pro/text-to-video', 'effects',
   ...
   'https://rustfs.gptweb.ru/presets/water-splash.mp4',
  ...
  ('glass-shatter', 'video', 'kwaivgi/kling-v3.0-pro/text-to-video', 'effects',
   ...
   '{"aspect_ratio":"16:9","duration_sec":4}',
   'https://rustfs.gptweb.ru/presets/glass-shatter.mp4',
   ARRAY['new'], 160),
  ...
  ('moonwalk-left', 'video', 'kwaivgi/kling-v3.0-pro/text-to-video', 'character',
   ...
   '{"aspect_ratio":"16:9","duration_sec":5}',
   'https://rustfs.gptweb.ru/presets/moonwalk-left.mp4',
   ARRAY[]::text[], 230),
  ...
  ('hero-flight', 'video', 'bytedance/seedance-2.0-fast/text-to-video', 'character',
   ...
   '{"aspect_ratio":"16:9","duration_sec":5}',
   'https://rustfs.gptweb.ru/presets/hero-flight.mp4',
  ...
  ('golden-hour-walk', 'video', 'bytedance/seedance-2.0-fast/text-to-video', 'ambient',
   ...
   '{"aspect_ratio":"16:9","duration_sec":5}',
   'https://rustfs.gptweb.ru/presets/golden-hour-walk.mp4',
   ARRAY[]::text[], 330),
  ...
  ('neon-night-streets', 'video', 'kwaivgi/kling-v3.0-pro/text-to-video', 'ambient',
   ...
   '{"aspect_ratio":"16:9","duration_sec":5}',
   'https://rustfs.gptweb.ru/presets/neon-night-streets.mp4',
  ...
  ('motorcycle-chase', 'video', 'bytedance/seedance-2.0-fast/text-to-video', 'action',
   ...
   '{"aspect_ratio":"16:9","duration_sec":5}',
   'https://rustfs.gptweb.ru/presets/motorcycle-chase.mp4',
  ...
  ('parkour-leap', 'video', 'kwaivgi/kling-v3.0-pro/text-to-video', 'action',
   ...
   '{"aspect_ratio":"16:9","duration_sec":4}',
   'https://rustfs.gptweb.ru/presets/parkour-leap.mp4',
   ARRAY['trending'], 420),
  ...
  ('sword-fight', 'video', 'kwaivgi/kling-v3.0-pro/text-to-video', 'action',
   ...
   '{"aspect_ratio":"16:9","duration_sec":5}',
   'https://rustfs.gptweb.ru/presets/sword-fight.mp4',
   ARRAY[]::text[], 430),
  ...
  ('dance-spin', 'video', 'bytedance/seedance-2.0-fast/text-to-video', 'action',
   ...
   '{"aspect_ratio":"16:9","duration_sec":5}',
   'https://rustfs.gptweb.ru/presets/dance-spin.mp4',
   ARRAY['new'], 440)
...
VALUES
  ...
  ('portrait-cyberpunk', 'image', 'wavespeed-ai/flux-1.1-pro-ultra', 'portrait',
   ...
   '{"aspect_ratio":"3:4"}',
   'https://rustfs.gptweb.ru/presets/portrait-cyberpunk.mp4',
   ARRAY['trending'], 40),
  ...
  ('portrait-renaissance', 'image', 'wavespeed-ai/flux-1.1-pro-ultra', 'portrait',
   ...
   '{"aspect_ratio":"3:4"}',
   'https://rustfs.gptweb.ru/presets/portrait-renaissance.mp4',
   ARRAY['top_choice'], 50),
  ...
  ('portrait-vintage-film', 'image', 'wavespeed-ai/flux-1.1-pro-ultra', 'portrait',
   ...
   '{"aspect_ratio":"3:4"}',
   'https://rustfs.gptweb.ru/presets/portrait-vintage-film.mp4',
   ARRAY[]::text[], 60),
  ...
  ('landscape-aerial', 'image', 'wavespeed-ai/flux-1.1-pro-ultra', 'landscape',
   ...
   '{"aspect_ratio":"16:9"}',
   'https://rustfs.gptweb.ru/presets/landscape-aerial.mp4',
  ...
  ('landscape-japanese-mountain', 'image', 'wavespeed-ai/flux-1.1-pro-ultra', 'landscape',
   ...
   '{"aspect_ratio":"16:9"}',
   'https://rustfs.gptweb.ru/presets/landscape-japanese-mountain.mp4',
   ARRAY['trending'], 140),
  ...
  ('landscape-cosmic-vista', 'image', 'wavespeed-ai/flux-1.1-pro-ultra', 'landscape',
   ...
   '{"aspect_ratio":"16:9"}',
   'https://rustfs.gptweb.ru/presets/landscape-cosmic-vista.mp4',
   ARRAY['new'], 150),
  ...
  ('anime-cyberpunk', 'image', 'google/nano-banana-pro/text-to-image', 'anime',
   ...
   '{"aspect_ratio":"16:9"}',
   'https://rustfs.gptweb.ru/presets/anime-cyberpunk.mp4',
  ...
  ('anime-dark-noir', 'image', 'google/nano-banana-pro/text-to-image', 'anime',
   ...
   '{"aspect_ratio":"16:9"}',
   'https://rustfs.gptweb.ru/presets/anime-dark-noir.mp4',
   ARRAY[]::text[], 240),
  ...
  ('realistic-architectural', 'image', 'wavespeed-ai/flux-1.1-pro-ultra', 'realistic',
   ...
   '{"aspect_ratio":"4:3"}',
   'https://rustfs.gptweb.ru/presets/realistic-architectural.mp4',
   ARRAY[]::text[], 340),
  ...
  ('realistic-street-photo', 'image', 'wavespeed-ai/flux-1.1-pro-ultra', 'realistic',
   ...
   '{"aspect_ratio":"3:2"}',
   'https://rustfs.gptweb.ru/presets/realistic-street-photo.mp4',
   ARRAY['trending'], 350),
  ...
  ('product-tech', 'image', 'wavespeed-ai/flux-1.1-pro-ultra', 'product',
   ...
   '{"aspect_ratio":"1:1"}',
   'https://rustfs.gptweb.ru/presets/product-tech.mp4',
  ...
  ('product-cosmetic', 'image', 'wavespeed-ai/flux-1.1-pro-ultra', 'product',
   ...
   '{"aspect_ratio":"1:1"}',
   'https://rustfs.gptweb.ru/presets/product-cosmetic.mp4',
   ARRAY[]::text[], 440),
  ...
  ('art-oil-painting', 'image', 'wavespeed-ai/flux-1.1-pro-ultra', 'artistic',
   ...
   '{}'::jsonb,
   'https://rustfs.gptweb.ru/presets/art-oil-painting.mp4',
  ...
  ('art-watercolor', 'image', 'wavespeed-ai/flux-1.1-pro-ultra', 'artistic',
   ...
   '{}'::jsonb,
   'https://rustfs.gptweb.ru/presets/art-watercolor.mp4',
   ARRAY[]::text[], 520),
  ...
  ('art-pop-art', 'image', 'wavespeed-ai/flux-1.1-pro-ultra', 'artistic',
   ...
   '{}'::jsonb,
   'https://rustfs.gptweb.ru/presets/art-pop-art.mp4',
   ARRAY['trending'], 530),
  ...
  ('art-impressionism', 'image', 'wavespeed-ai/flux-1.1-pro-ultra', 'artistic',
   ...
   '{}'::jsonb,
   'https://rustfs.gptweb.ru/presets/art-impressionism.mp4',
   ARRAY[]::text[], 540),
  ...
  ('art-pixel', 'image', 'wavespeed-ai/flux-1.1-pro-ultra', 'artistic',
   ...
   '{}'::jsonb,
   'https://rustfs.gptweb.ru/presets/art-pixel.mp4',
   ARRAY['new'], 550)
ON CONFLICT (slug) DO NOTHING;
