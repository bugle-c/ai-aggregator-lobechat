...
export const userAttribution = pgTable(
  'user_attribution',
  {
    ...
    firstYmClientId: text('first_ym_client_id'),
    firstGaClientId: text('first_ga_client_id'),
    firstRoistatVisit: text('first_roistat_visit'),
    firstAnalyticsIds: jsonb('first_analytics_ids').$type<Record<string, string>>(),
    ...
    lastYmClientId: text('last_ym_client_id'),
    lastGaClientId: text('last_ga_client_id'),
    lastRoistatVisit: text('last_roistat_visit'),
    lastAnalyticsIds: jsonb('last_analytics_ids').$type<Record<string, string>>(),
