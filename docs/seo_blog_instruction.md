...
### 📊 LIVE STATE (auto, обновлено 2026-06-20 04:00 МСК)

**Контент:** published **280** · archived 125 · draft 0
· keywords pending **76** (из них VPN: 0 — должно быть \~0)
· clusters used 232 · reoptimize pending 0

**Новости:** профиль истекает **2026-07-19** (осталось 29 дн.) · pipeline 🟢 ok (профиль активен)
...
| Сервис            | Статус    | Когда                   |
| ----------------- | --------- | ----------------------- |
| `blog-generate`   | 🟢 exit=0 | 2026-06-19 22:25:02 MSK |
| `blog-hype`       | 🟢 exit=0 | 2026-06-19 19:38:30 MSK |
| `blog-keywords`   | 🟢 exit=0 | 2026-06-20 03:00:03 MSK |
| `blog-positions`  | 🟢 exit=0 | 2026-06-19 04:06:47 MSK |
| `blog-sync`       | 🟢 exit=0 | 2026-06-19 06:00:15 MSK |
| `blog-reoptimize` | 🟢 exit=0 | 2026-06-20 04:00:01 MSK |
