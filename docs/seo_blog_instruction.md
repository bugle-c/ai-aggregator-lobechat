...
### 📊 LIVE STATE (auto, обновлено 2026-09-07 04:00 МСК)

**Контент:** published **347** · archived 164 · draft 0
· keywords pending **2** (из них VPN: 0 — должно быть \~0)
· clusters used 332 · reoptimize pending 0

**Новости:** профиль истекает **1970-02-10** (осталось 0 дн.) · pipeline 🔴 profile_expired — продли профиль (§6.1)
...
| Сервис            | Статус    | Когда                   |
| ----------------- | --------- | ----------------------- |
| `blog-generate`   | 🔴 exit=1 | 2026-09-06 22:35:37 MSK |
| `blog-hype`       | 🟢 exit=0 | ?                       |
| `blog-keywords`   | 🟢 exit=0 | 2026-09-07 03:00:03 MSK |
| `blog-positions`  | 🟢 exit=0 | 2026-09-06 04:05:03 MSK |
| `blog-sync`       | 🟢 exit=0 | 2026-09-06 06:00:34 MSK |
| `blog-reoptimize` | 🟢 exit=0 | 2026-09-07 04:00:01 MSK |
