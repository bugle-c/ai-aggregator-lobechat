...
### 📊 LIVE STATE (auto, обновлено 2026-06-21 04:00 МСК)

**Контент:** published **263** · archived 147 · draft 0
· keywords pending **51** (из них VPN: 0 — должно быть \~0)
· clusters used 237 · reoptimize pending 0

**Новости:** профиль истекает **2026-07-19** (осталось 28 дн.) · pipeline 🟢 ok (профиль активен)
...
| Сервис            | Статус    | Когда                   |
| ----------------- | --------- | ----------------------- |
| `blog-generate`   | 🟢 exit=0 | 2026-06-20 22:35:28 MSK |
| `blog-hype`       | 🟢 exit=0 | 2026-06-20 19:34:45 MSK |
| `blog-keywords`   | 🟢 exit=0 | 2026-06-21 03:00:03 MSK |
| `blog-positions`  | 🟢 exit=0 | 2026-06-20 04:08:24 MSK |
| `blog-sync`       | 🟢 exit=0 | 2026-06-20 06:00:12 MSK |
| `blog-reoptimize` | 🟢 exit=0 | 2026-06-21 04:00:00 MSK |
