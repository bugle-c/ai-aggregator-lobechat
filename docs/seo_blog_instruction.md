...
### 📊 LIVE STATE (auto, обновлено 2026-06-19 04:00 МСК)

**Контент:** published **272** · archived 125 · draft 0
· keywords pending **86** (из них VPN: 0 — должно быть \~0)
· clusters used 226 · reoptimize pending 0

**Новости:** профиль истекает **2026-07-19** (осталось 30 дн.) · pipeline 🟢 ok (профиль активен)
...
| Сервис            | Статус    | Когда                   |
| ----------------- | --------- | ----------------------- |
| `blog-generate`   | 🟢 exit=0 | 2026-06-18 22:32:18 MSK |
| `blog-hype`       | 🟢 exit=0 | 2026-06-18 19:42:39 MSK |
| `blog-keywords`   | 🟢 exit=0 | 2026-06-19 03:00:03 MSK |
| `blog-positions`  | 🟢 exit=0 | 2026-06-18 04:03:12 MSK |
| `blog-sync`       | 🟢 exit=0 | 2026-06-18 06:00:11 MSK |
| `blog-reoptimize` | 🟢 exit=0 | 2026-06-19 04:00:02 MSK |
