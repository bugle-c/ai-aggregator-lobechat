...
### 📊 LIVE STATE (auto, обновлено 2026-06-18 04:00 МСК)

**Контент:** published **266** · archived 125 · draft 0
· keywords pending **111** (из них VPN: 0 — должно быть \~0)
· clusters used 222 · reoptimize pending 0

**Новости:** профиль истекает **2026-07-19** (осталось 31 дн.) · pipeline 🟢 ok (профиль активен)
...
| Сервис            | Статус    | Когда                   |
| ----------------- | --------- | ----------------------- |
| `blog-generate`   | 🟢 exit=0 | 2026-06-17 22:32:59 MSK |
| `blog-hype`       | 🟢 exit=0 | 2026-06-17 19:38:16 MSK |
| `blog-keywords`   | 🟢 exit=0 | 2026-06-18 03:00:03 MSK |
| `blog-positions`  | 🟢 exit=0 | 2026-06-17 04:04:58 MSK |
| `blog-sync`       | 🟢 exit=0 | 2026-06-17 06:00:12 MSK |
| `blog-reoptimize` | 🟢 exit=0 | 2026-06-18 04:00:01 MSK |
