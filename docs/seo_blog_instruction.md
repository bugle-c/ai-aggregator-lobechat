...
### 📊 LIVE STATE (auto, обновлено 2026-07-22 04:00 МСК)

**Контент:** published **323** · archived 152 · draft 0
· keywords pending **1** (из них VPN: 0 — должно быть \~0)
· clusters used 297 · reoptimize pending 0

**Новости:** профиль истекает **2026-08-29** (осталось 38 дн.) · pipeline 🟢 ok (профиль активен)
...
| Сервис            | Статус    | Когда                   |
| ----------------- | --------- | ----------------------- |
| `blog-generate`   | 🟢 exit=0 | 2026-07-21 22:14:23 MSK |
| `blog-hype`       | 🟢 exit=0 | 2026-07-21 19:43:49 MSK |
| `blog-keywords`   | 🟢 exit=0 | 2026-07-22 03:00:06 MSK |
| `blog-positions`  | 🟢 exit=0 | 2026-07-21 04:06:44 MSK |
| `blog-sync`       | 🟢 exit=0 | 2026-07-21 06:00:16 MSK |
| `blog-reoptimize` | 🟢 exit=0 | 2026-07-22 04:00:00 MSK |
