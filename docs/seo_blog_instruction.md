...
### 📊 LIVE STATE (auto, обновлено 2026-06-23 04:00 МСК)

**Контент:** published **274** · archived 148 · draft 0
· keywords pending **17** (из них VPN: 0 — должно быть \~0)
· clusters used 248 · reoptimize pending 0

**Новости:** профиль истекает **2026-07-19** (осталось 26 дн.) · pipeline 🟢 ok (профиль активен)
...
| Сервис            | Статус    | Когда                   |
| ----------------- | --------- | ----------------------- |
| `blog-generate`   | 🟢 exit=0 | 2026-06-22 22:00:55 MSK |
| `blog-hype`       | 🟢 exit=0 | 2026-06-22 19:36:54 MSK |
| `blog-keywords`   | 🟢 exit=0 | 2026-06-23 03:00:03 MSK |
| `blog-positions`  | 🟢 exit=0 | 2026-06-22 04:08:53 MSK |
| `blog-sync`       | 🟢 exit=0 | 2026-06-22 06:00:13 MSK |
| `blog-reoptimize` | 🟢 exit=0 | 2026-06-23 04:00:01 MSK |
