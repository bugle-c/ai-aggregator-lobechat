...
### 📊 LIVE STATE (auto, обновлено 2026-06-22 04:00 МСК)

**Контент:** published **267** · archived 147 · draft 0
· keywords pending **24** (из них VPN: 0 — должно быть \~0)
· clusters used 241 · reoptimize pending 0

**Новости:** профиль истекает **2026-07-19** (осталось 27 дн.) · pipeline 🟢 ok (профиль активен)
...
| Сервис            | Статус    | Когда                   |
| ----------------- | --------- | ----------------------- |
| `blog-generate`   | 🟢 exit=0 | 2026-06-21 22:18:01 MSK |
| `blog-hype`       | 🟢 exit=0 | 2026-06-21 19:35:28 MSK |
| `blog-keywords`   | 🟢 exit=0 | 2026-06-22 03:00:02 MSK |
| `blog-positions`  | 🟢 exit=0 | 2026-06-21 04:01:03 MSK |
| `blog-sync`       | 🟢 exit=0 | 2026-06-21 06:00:14 MSK |
| `blog-reoptimize` | 🟢 exit=0 | 2026-06-22 04:00:00 MSK |
