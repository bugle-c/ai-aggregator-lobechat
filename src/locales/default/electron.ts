export default {
  ...
  'remoteServer.configDesc': 'Connect to the remote WebGPT server to enable data synchronization',
  ...
  'sync.lobehubCloud.title': 'WebGPT Cloud',
