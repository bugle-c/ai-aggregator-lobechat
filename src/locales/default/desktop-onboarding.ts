export default {
  ...
  'authResult.success.desc':
    'Please click the Start button below to continue using WebGPT Desktop',
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve WebGPT. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve WebGPT',
  ...
  'screen5.actions.signInCloud': 'Sign in to WebGPT Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your WebGPT Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'WebGPT Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own WebGPT server instance',
