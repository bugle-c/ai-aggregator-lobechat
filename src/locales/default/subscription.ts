export default {
  ...
  'plans.plan.basic.desc': 'For regular users who need more models and tokens',
  'plans.plan.basic.title': 'Basic',
  'plans.plan.free.desc': 'For first-time users',
  'plans.plan.free.title': 'Free',
  'plans.plan.pro.desc': 'For power users who need all models and maximum tokens',
  'plans.plan.pro.title': 'Pro',
  ...
  // Subscription activated modal (post-payment)
  'activated.continue': 'Продолжить',
  'activated.continueWith': 'Продолжить с {{model}}',
  'activated.cost': '{{cost}} кр/запрос',
  'activated.desc': 'Что теперь доступно',
  'activated.keepModel': 'Оставить текущую модель',
  'activated.tier.basic': 'Быстрые и средние модели — GPT-5 mini, GPT-4.1 mini, Claude Haiku',
  'activated.tier.free': 'Быстрые базовые модели',
  'activated.tier.pro':
    'Все модели среднего и высокого уровня — Claude Sonnet, GPT-5.1, DeepSeek Reasoner',
  'activated.tier.pro_max': 'Все модели, включая премиум — Claude Opus, GPT-5.2',
  'activated.title': 'Тариф «{{plan}}» активирован',
  ...
  'sidebar.referral': 'Пригласить',

  // Referrals page (Phase 2.1 user-facing UI)
  'referrals.title': 'Пригласите друзей',
  'referrals.subtitle': 'Получайте бонусы за каждого приглашённого',
  ...
  'referrals.shareX': 'X (Twitter)',
  'referrals.shareLabel': 'Поделиться',
  'referrals.shareMessage':
    'Регистрируйся в GPTWeb по моей ссылке — привяжи Telegram и получите с другом по +100 кредитов: {{link}}',
  'referrals.bonusListTitle': 'Как это работает',
  'referrals.bonusHowItWorks':
    'Бонусы начисляются обоим, когда друг зарегается и привяжет Telegram. Кредиты действуют 30 дней.',
  'referrals.bonusReferred': '+100 кредитов другу (на 30 дней) — при привязке Telegram',
  'referrals.bonusL1': '+100 кредитов вам (на 30 дней) — когда друг привяжет Telegram',
  'referrals.bonusL2': '+30 кредитов вам (на 30 дней) — с L2: друг вашего друга',
  'referrals.totalEarned': 'Заработано',
  'referrals.totalReferred': 'Приглашено',
  'referrals.creditsUnit': 'кредитов',
  'referrals.peopleUnit': 'чел.',
  'referrals.pendingTg': 'Ждут привязки TG',
  'referrals.noReferrals': 'Пока никто не зарегистрировался по вашей ссылке',
  'referrals.tableTitle': 'Ваши приглашённые',
  'referrals.table.user': 'Пользователь',
  'referrals.table.level': 'Уровень',
  'referrals.table.status': 'Статус',
  'referrals.table.credits': 'Кредиты',
  'referrals.table.date': 'Дата',
  'referrals.status.pending': 'Ждёт привязки TG',
  'referrals.status.rewarded': 'Награда получена',
  'referrals.status.rejected_abuse': 'Отклонено',
  'referrals.status.rejected_no_tg': 'Без привязки TG',
  'referrals.cashout.title': 'Вывести кредиты',
  'referrals.cashout.description': 'Обменяйте кредиты на рубли',
  'referrals.cashout.rate': 'Курс: 1 кредит = {{rate}} ₽',
  'referrals.cashout.minimum': 'Минимум: {{min}} кредитов (= {{minRub}} ₽)',
  'referrals.cashout.balance': 'Доступно: {{balance}} кредитов',
  'referrals.cashout.request': 'Запросить вывод',
  'referrals.cashout.modalTitle': 'Запрос на вывод',
  'referrals.cashout.amount': 'Количество кредитов',
  'referrals.cashout.amountHint': 'Эквивалент: {{rub}} ₽',
  'referrals.cashout.method': 'Способ оплаты',
  'referrals.cashout.details': 'Реквизиты',
  'referrals.cashout.detailsPlaceholderCard': 'Номер карты (16 цифр)',
  'referrals.cashout.detailsPlaceholderSbp': 'Номер телефона (+7...)',
  'referrals.cashout.detailsPlaceholderSber': 'Номер телефона или карты Сбера',
  'referrals.cashout.methodCard': 'Банковская карта',
  'referrals.cashout.methodSbp': 'СБП (по номеру телефона)',
  'referrals.cashout.methodSber': 'Сбербанк Онлайн',
  'referrals.cashout.cancel': 'Отмена',
  'referrals.cashout.submit': 'Отправить запрос',
  'referrals.cashout.successToast': 'Запрос принят, обработаем в течение 3 рабочих дней',
  'referrals.cashout.errorBalance': 'Недостаточно кредитов',
  'referrals.cashout.errorMinimum': 'Минимум {{min}} кредитов',
  'referrals.cashout.history': 'История выводов',
  'referrals.cashout.historyEmpty': 'Запросов на вывод пока не было',
  'referrals.cashout.historyAmount': '{{credits}} кредитов = {{rub}} ₽',
  'referrals.cashout.historyStatus.pending': 'Ожидает',
  'referrals.cashout.historyStatus.approved': 'Одобрен',
  'referrals.cashout.historyStatus.paid': 'Выплачен',
  'referrals.cashout.historyStatus.rejected': 'Отклонён',
