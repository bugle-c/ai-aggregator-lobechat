export default {
  ...
  'referrals.shareMessage':
    'Регистрируйся в GPTWeb по моей ссылке — получишь +20 кредитов на старте: {{link}}',
  'referrals.bonusListTitle': 'Что вы получаете',
  'referrals.bonusReferred': '+20 кредитов другу при регистрации',
  'referrals.bonusL1': '+50 кредитов вам, когда друг купит подписку',
  'referrals.bonusL2': '+25 кредитов с друга вашего друга',
  'referrals.totalEarned': 'Заработано',
  'referrals.totalReferred': 'Приглашено',
  'referrals.creditsUnit': 'кредитов',
  'referrals.peopleUnit': 'чел.',
  'referrals.pendingPayments': 'Ожидают платежа',
  ...
  'referrals.status.pending': 'Ждёт платежа',
  'referrals.status.rewarded': 'Награда получена',
  'referrals.status.rejected_abuse': 'Отклонено',
  'referrals.status.rejected_no_payment': 'Без платежа',
