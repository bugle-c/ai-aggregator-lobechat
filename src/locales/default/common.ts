export default {
  ...
  'branchingDisable':
    'The "Sub-topic" feature is unavailable in the current mode. To use this feature, please switch to Postgres/Pglite DB mode or use WebGPT Cloud.',
  ...
  'mail.support': 'Support in Telegram',
  'more': 'More',
  ...
  'password': 'Password',
  'pin': 'Pin',
  'preset.addPhoto': 'Add a photo',
  'preset.allCategories': 'All',
  'preset.allModels': 'All models',
  'preset.categories': 'Categories',
  'preset.continueOn': 'Continue with {{model}}',
  'preset.credits': '≈ {{count}} cr',
  'preset.details': 'Details',
  'preset.empty': 'No presets found',
  'preset.generate': 'Generate',
  'preset.generating': 'Generating…',
  'preset.insufficientCredits': 'Not enough credits — top up',
  'preset.loadMore': 'Load more',
  'preset.model': 'Model',
  'preset.modelSwitched': 'Model switched to {{model}}',
  'preset.prompt.detach': 'Remove style',
  'preset.prompt.edit': 'Edit',
  'preset.prompt.hint': 'This is what the model receives',
  'preset.prompt.title': 'Style prompt',
  'preset.promptOptional': 'What to add? Optional',
  'preset.recommendedLocked': 'Recommended — {{model}}, on the {{plan}} plan',
  'preset.remove': 'Remove',
  'preset.requiresImage': 'Needs a photo',
  'preset.requiresImageHint': 'This style animates your photo',
  'preset.requiresImageShort': 'Photo',
  'preset.resetFilters': 'Reset filters',
  'preset.resultMayDiffer': 'The result may differ',
  'preset.revert': 'Revert',
  'preset.searchPlaceholder': 'Search',
  'preset.settings.aspect': 'Aspect ratio',
  'preset.settings.count': 'Count',
  'preset.settings.countUnit': '{{count}} pcs',
  ...
  'preset.sortLabel': 'Sort',
  'preset.styleTunedFor': 'This style is tuned for {{model}}',
  'preset.useStyle': 'Use style',
  'pinOff': 'Unpin',
  ...
  'userPanel.email': 'Support in Telegram',
