...
describe('getCanonicalUrl', () => {
  ...
  it('should return correct URL for production environment', async () => {
    ...
    expect(result).toBe('https://ask.gptweb.ru/path/to/page');
    expect(urlJoin).toHaveBeenCalledWith('https://ask.gptweb.ru', 'path', 'to', 'page');
  });
  ...
  it('should work correctly without additional path arguments', async () => {
    ...
    expect(urlJoin).toHaveBeenCalledWith('https://ask.gptweb.ru');
  });
});
